                                ...
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle"
                                            src="{{ ($post->user->avatar ? url($post->user->avatar) : $post->user->gender == 1) ? url('img/samples/avatar5.png') : url('img/samples/avatar2.png') }}"
                            ...
                            <div class="post clearfix">
                                <div class="user-block">
                                    <img class="img-circle img-bordered-sm"
                                        src="{{ ($comment->user->avatar ? url($comment->user->avatar) : $comment->user->gender == 1) ? url('img/samples/avatar5.png') : url('img/samples/avatar2.png') }}"
                                        alt="User Image">
                                    <span class="username">
