                        ...
                        <form id="myform" action="{{ route('admin.mbposts.update', $post->id) }}" method="POST" role="form">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" id="title" name="title" value="{{ $post->title }}" placeholder="輸入標題" required>
                                    @if ($errors->has('title'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4 select2-primary {{ $errors->has('type') ? ' is-invalid' : '' }}" data-dropdown-css-class="select2-primary" name="type" required>
                                ...
                                <div class="form-group">
                                    <label>內容</label>
                                    <textarea class="form-control {{ $errors->has('content') ? ' is-invalid' : '' }} " rows="3" id="content" name="content" placeholder="Enter ..." required>{{ $post->content ?? '' }}</textarea>
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control datetimepicker {{ $errors->has('onlinedate') ? ' is-invalid' : '' }}" id="onlinedate" name="onlinedate" value="{{ $post->onlinedate ?? '' }}" placeholder="上線日期時間" required>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control datetimepicker {{ $errors->has('offlinedate') ? ' is-invalid' : '' }}" id="offlinedate" name="offlinedate" value="{{ $post->offlinedate ?? '' }}" placeholder="下線日期時間">
                                ...
                                <div class="row">
                                    <div class="form-group col-6" style="background-color:#f0f0f0">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-secondary d-inline mr-2">
                                                <input type="radio" id="approved_wait" name="approved" value="0" {{ $post->approved == 0 ? 'checked' : '' }}>
                                                <label for="approved_wait">等待中</label>
                                            </div>
                                            <div class="icheck-green d-inline mr-2">
                                                <input type="radio" id="approved_pass" name="approved" value="1" {{ $post->approved == 1 ? 'checked' : '' }}>
                                                <label for="approved_pass">通過</label>
                                            </div>
                                            <div class="icheck-danger d-inline mr-2">
                                                <input type="radio" id="approved_denie" name="approved" value="2" {{ $post->approved == 2 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <div class="input-group">
                                            <input type="checkbox" name="isshow" value="1" data-bootstrap-switch data-off-color="secondary" data-on-color="success" {{ $post->isshow == 1 ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="form-group col-3">
                                        <label for="offlinedate">置頂狀態</label>
                                        <div class="input-group">
                                            <input type="checkbox" name="istop" value="1" data-bootstrap-switch data-off-color="secondary" data-on-color="primary" {{ $post->istop == 1 ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-primary card-outline col-4">
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle" src="{{ $post->user->avatar ? asset($post->user->avatar) : asset('img/noavatar.png') }}" alt="User profile picture">
                                    </div>
                            ...
                            <div class="card card-primary card-outline col-8">
                                <div class="card-body box-profile">
                                    ...
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                        <li class="mb-2"><span class="fa-li"><i class="fas fa-venus-mars"></i></span>{{ $post->user->gender == 1 ? '男' : '女' }}
                                        </li>
                                        <li class="mb-2"><span class="fa-li"><i class="fas fa-envelope"></i></span>{{ $post->user->email }}</li>
                                        <li class="mb-2"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span>{{ $post->user->tel }}</li>
                                        <li class="mb-2"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span>{{ $post->user->address }}
                                        </li>
                                    </ul>
                                </div>
                            </div>
